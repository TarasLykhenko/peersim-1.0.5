...
public class Settings {
    ...
    public static final int REST_TIME = 1000;
    public static final int REST_TIME_INTERVAL = 200;

    public static final int CLIENT_READ_PERCENTAGE = 90;
    public static final int CLIENT_UPDATE_PERCENTAGE = 10;

    public static final String CLIENT_READ_LEVEL_PERCENTAGE = "[30,30,40]";
    public static final String CLIENT_UPDATE_LEVEL_PERCENTAGE = "[30,30,40]";
     ...
     */
    public static final String CLIENT_LOCALITY_PERCENTAGE = "[0,0,50]";

    public static final int CLIENT_EAGER_PERCENTAGE = 30;
    public static final int TOTAL_OBJECTS_PER_DATACENTER = 100;
    public static final String LEVELS_PERCENTAGE = "[30,30,40]";
