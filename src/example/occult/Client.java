...
public class Client {
    ...
    /**
     * Maps shardId to shardStamp
     */
    Map<Integer, Integer> causalTimestamp = new HashMap<>();
    ...
    private Operation doUpdate() {
        ...
        Object shardId = GroupsManager.getShard(randomDataObject);
        Object masterServer = GroupsManager.getMasterOfShard(shardId);
        Object shardStamp = masterServer.write(randomDataObject.getKey(), causalTimestamp);
        updateCausalTimestamp(shardStamp, causalTimestamp);
