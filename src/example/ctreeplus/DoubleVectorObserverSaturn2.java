...
*/
public class DoubleVectorObserverSaturn2 implements Control {
 ...
 */
public DoubleVectorObserverSaturn2(String name)
{
	this.name = name;
	...
	if (iteration==cycles){
		...
		try {
			...
			for (int i = 0; i < Network.size(); i++)
			{
				...
				DoubleVectorSaturn2 v = (DoubleVectorSaturn2)Network.get(i).getProtocol(pid);
				System.out.println("[Node "+i+"]=========================");
				//System.out.println("Processed "+v.processedToString());
				System.out.println("Average processing time: "+v.getAverageProcessingTime());
