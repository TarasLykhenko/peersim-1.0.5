...
python plotter-all.py output/capstone.txt capstone output/saturn.txt saturn output/cops.txt cops output/occult.txt occult output/occult-compression.txt occult-compression
